...
public final class ResourceUtil {
     ...
     */
    public static boolean copyFileFromAssets(@NonNull Context context, final String assetsFilePath, final String destFilePath) {
        boolean res = true;
        try {
     ...
     * @return the content of assets
     */
    public static String readAssets2String(@NonNull Context context, final String assetsFilePath) {
     ...
     * @return the content of assets
     */
    public static String readAssets2String(@NonNull Context context,
                                           final String assetsFilePath, final String charsetName) {
        InputStream is;
        try {
     ...
     * @return the content of file in assets
     */
    public static List<String> readAssets2List(@NonNull Context context, final String assetsPath) {
     ...
     * @return the content of file in assets
     */
    public static List<String> readAssets2List(@NonNull Context context,
     ...
     * @return {@code true}: success<br>{@code false}: fail
     */
    public static boolean copyFileFromRaw(@NonNull Context context, @RawRes final int resId, final String destFilePath) {
     ...
     * @return the content of resource in raw
     */
    public static String readRaw2String(@NonNull Context context, @RawRes final int resId) {
     ...
     * @return the content of resource in raw
     */
    public static String readRaw2String(@NonNull Context context, @RawRes final int resId, final String charsetName) {
     ...
     * @return the content of file in assets
     */
    public static List<String> readRaw2List(@NonNull Context context, @RawRes final int resId) {
     ...
     * @return the content of file in assets
     */
    public static List<String> readRaw2List(@NonNull Context context,
