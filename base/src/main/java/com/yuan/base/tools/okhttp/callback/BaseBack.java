 ...
 */
public abstract class BaseBack<T> implements Callback {
    ...
    public void onResponse(final Call call, final Response response) throws IOException {
        Observable.create(new ObservableOnSubscribe<Object>() {
            ...
            public void subscribe(@NonNull ObservableEmitter<Object> e) throws Exception {
                /*处理
                 */
                t = ReflexUtil.getT(BaseBack.this, 0);
                if (t == null) {
                    //不存在泛型的情况,直接返回json
     ...
     * @return 传入泛型
     */
    protected Object parseJson(@NonNull String json) {
        T entity = (T) new Gson().fromJson(json, ReflexUtil.getT(BaseBack.this, 0).getClass());
        return entity;
    }
