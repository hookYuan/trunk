    ...
    private RLVAdapter getAdapter() {
        RLVAdapter adapter = new RLVAdapter(mContext) {
            ...
            public int getItemLayout(ViewGroup parent, int viewType) {
                return RLVTitleFragment.this.getItemLayout(parent, viewType);
            }

            @Override
            public void onBindHolder(ViewHolder holder, int position) {
                RLVTitleFragment.this.onBindHolder(holder, position);
            }
            ...
            public void onItemClick(ViewHolder holder, View view, int position) {
                RLVTitleFragment.this.onItemClick(holder, view, position);
            }
        };
        return adapter;
    }
