package com.yuan.base.widget.fold;
...
public class FoldTextView extends AppCompatTextView implements View.OnClickListener {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            TypedArray typed = context.obtainStyledAttributes(attrs, R.styleable.FoldTextView);
            setExpandedText(typed.getString(R.styleable.FoldTextView_ctv_expandedText));
            setCollapsedText(typed.getString(R.styleable.FoldTextView_ctv_collapsedText));
            setExpandedDrawable(typed.getDrawable(R.styleable.FoldTextView_ctv_expandedDrawable));
            setCollapsedDrawable(typed.getDrawable(R.styleable.FoldTextView_ctv_collapsedDrawable));
            setmCollapsedTextNum(typed.getInteger(R.styleable.FoldTextView_ctv_textNum, 50));
            mTipsGravity = typed.getInt(R.styleable.FoldTextView_ctv_tipsGravity, END);
            mTipsColor = typed.getColor(R.styleable.FoldTextView_ctv_tipsColor, 0);
            mTipsUnderline = typed.getBoolean(R.styleable.FoldTextView_ctv_tipsUnderline, false);
