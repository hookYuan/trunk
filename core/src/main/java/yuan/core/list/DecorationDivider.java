...
public class DecorationDivider extends RecyclerView.ItemDecoration {
    ...
    public DecorationDivider(Context context) {
    ...
    public DecorationDivider(int height, @ColorInt int color) {
    ...
    public DecorationDivider(int height, @ColorInt int color, @ColorInt int bgColor) {
        mDividerWidth = height;
